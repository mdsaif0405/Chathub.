...
<style type="text/css">
    ...
    .modal {
      ...
      background-color: rgb(0,0,0); /* Fallsubmit color */
    ...
    .form:hover{
        ...
        box-shadow: 0 0 15px rgb(32 178 170);
        /* border: 1px solid rgba(81, 203, 238, 1); */
    }
</style>
<?php
...
?>
    <!-- Page Content  -->
      <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                <h1 class="profile" style="margin:0%;"><?php echo $row['fname']."'s";?> Profile</h1>
            <form>
                ...
                <div class="form">
                    ...
                    <a id="submit" href="friend_list.php">Go Back</a>
                </div>
            </form>
